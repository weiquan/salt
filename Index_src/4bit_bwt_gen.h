...
#ifndef _4BIT_BWT_GEN_H
#define _4BIT_BWT_GEN_H
#include <stdint.h>
...
#define DNA_OCC_SUM_EXCEPTION(sum)			((sum & 0xfefefefeff) == 0)
...
typedef struct BWT {
	...
	DECODE_TABLE_T  *decodeTable;			// For decoding BWT by table lookup
